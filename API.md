...
[const {clear_cache_localget} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L42)

Clears the cache used by [localget](#localget) and [localget_json](#localget_json)

## clear_cache_remoteget

[const {clear_cache_remoteget} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L49)

Clears the cache used by [remoteget](#remoteget) and [remoteget_json](#remoteget_json)

## localget

[const {localget} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L62)
...
[const {localget_json} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L78)
...
[const {remoteget} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L95)
...
[const {remoteget_json} = require('libs_common/cacheget_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/cacheget_utils.ls#L111)
...
[const {load_css_file} = require('libs_common/content_script_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/content_script_utils.ls#L14)
...
[const {load_css_code} = require('libs_common/content_script_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/content_script_utils.ls#L30)
...
[const {get_progress_on_enabled_goals_this_week} = require('libs_common/goal_progress')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_progress.ls#L113)
...
[const {list_enabled_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L78)
...
[const {get_enabled_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L91)
...
[const {list_all_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L225)
...
[const {get_goal_info} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L301)
...
[const {get_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L308)
...
[const {get_positive_enabled_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L387)
...
[const {get_positive_enabled_uncompleted_goals} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L400)
...
[const {get_random_positive_goal} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L419)
...
[const {get_random_uncompleted_positive_goal} = require('libs_common/goal_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/goal_utils.ls#L427)
...
[const {list_enabled_interventions} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L121)
...
[const {get_enabled_interventions} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L92)
...
[const {list_custom_interventions} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L407)
...
[const {list_all_interventions} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L495)
...
[const {get_intervention_info} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L538)
...
[const {get_interventions} = require('libs_common/intervention_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/intervention_utils.ls#L663)
...
[const {get_seconds_spent_on_current_domain_today} = require('libs_common/time_spent_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_common/time_spent_utils.ls#L68)
...
[const {printable_time_spent_long} = require('libs_common/time_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_common/time_utils.ls#L32)
...
[const {get_news_feed} = require('libs_frontend/facebook_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/facebook_utils.ls#L13)

Inject an HTMLElement into facebook news feeds

## inject_into_feed

[const {inject_into_feed} = require('libs_frontend/facebook_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/facebook_utils.ls#L24)
...
[const {getUrlParameters} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L10)
...
[const {once_available} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L32)
...
[const {once_available_fast} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L47)
...
[const {once_available_multiselect} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L62)
...
[const {once_body_available} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L75)
...
[const {on_url_change} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L90)
...
[const {on_url_change_not_from_history} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L103)
...
[const {create_shadow_div} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L130)
...
[const {wrap_in_shadow} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L170)
...
[const {create_shadow_div_on_body} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L183)
...
[const {append_to_body_shadow} = require('libs_frontend/frontend_libs')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/frontend_libs.ls#L197)
...
[const {close_selected_tab} = require('libs_common/tab_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/tab_utils.js#L5-L13)
...
[const {close_tab_with_id} = require('libs_common/tab_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/tab_utils.js#L19-L22)
...
[const {open_url_in_new_tab} = require('libs_common/tab_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/tab_utils.js#L28-L33)
...
[const {get_selected_tab_id} = require('libs_common/tab_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_backend/tab_utils.js#L39-L47)
...
[const {start_episode_tracker} = require('libs_frontend/netflix_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/netflix_utils.js#L9-L30)

If there's no running episode tracker, start one to track the number of episodes watched

## stop_episode_tracker

[const {stop_episode_tracker} = require('libs_frontend/netflix_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/netflix_utils.js#L35-L37)

Stop running episode tracker

## get_num_episodes_watched

[const {get_num_episodes_watched} = require('libs_frontend/netflix_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/netflix_utils.js#L43-L45)
...
[const {make_notification} = require('libs_frontend/notification_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/notification_utils.js#L18-L21)
...
[const {notification_onclick} = require('libs_frontend/notification_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/notification_utils.js#L31-L44)
...
[const {close_notification} = require('libs_frontend/notification_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/notification_utils.js#L53-L57)
...
[const {show_toast} = require('libs_frontend/toast_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/toast_utils.js#L12-L58)
...
[const {is_video_playing} = require('libs_frontend/youtube_utils')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/libs_frontend/youtube_utils.js#L5-L11)
...
[const {GoalInfo} = require('flowtypes/goal_info')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/flowtypes/goal_info.js#L14-L14)
...
[const {GoalName} = require('flowtypes/goal_name')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/flowtypes/goal_name.js#L6-L6)
...
[const {GoalProgressInfo} = require('flowtypes/goal_progress_info')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/flowtypes/goal_progress_info.js#L12-L12)
...
[const {InterventionInfo} = require('flowtypes/intervention_info')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/flowtypes/intervention_info.js#L13-L13)
...
[const {InterventionName} = require('flowtypes/intervention_name')](https://github.com/habitlab/habitlab/blob/bbfc63ec9f363dbd0723187752f34231a18401b4/src/flowtypes/intervention_name.js#L6-L6)
